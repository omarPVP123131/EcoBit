        ...
        child: Column(
          children: [
            ...
            Container(
                ...
                child: myText("EcoBit", Colors.white, 70)),
            Container(
                margin: EdgeInsets.only(top: size.height * 0.00000002),
                child: myText("Divierte Y Recicla", Colors.white, 24)),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: GestureDetector(
          ...
          child: myText("Sobre Nosotros", Colors.white, 20)),
    );
  }
}
